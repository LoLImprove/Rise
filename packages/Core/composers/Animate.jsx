 ...
 * Credits to https://github.com/elierotenberg/react-animate (3.0.0)
 *
 * This is simply a fork to make the library composable
 *
 * /!\ When composed, should always be called first because it properties directly on the component /!\
 *
 * Example
 *
...
Animate.extend = function (Component) {
    return class extends Component {
        constructor(props) {
            ...
            this.animator = Animate.animations;
        }
...
Animate.animations = {
    ...
    stylesFor(name, context = null) {
        context = context ? context : this.target();
        return Animate.getAnimatedStyle.call(context, name);
    },

    animationClass(context = null) {
        context = context ? context : this.target();
        return Animate.getAnimatedClass.call(context);
    },
    ...
    visibility: {
        ...
        slideDown(context, speed = 500, onComplete = (() => {})) {
            Animate.animate.call(context, 'visibility', { maxHeight: '0vh', opacity: 0 }, { maxHeight: '100vh', opacity: 1 }, speed, { easing: 'linear', onComplete: onComplete });   
        },
        slideUp(context, speed = 500, onComplete = (() => {})) {
            Animate.animate.call(context, 'visibility', { maxHeight: "100vh", opacity: 1 }, { maxHeight: '0vh', opacity: 0 }, speed, { easing: 'linear', onComplete: onComplete });   
        }
